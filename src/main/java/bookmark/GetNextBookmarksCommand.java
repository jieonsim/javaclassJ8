...
public class GetNextBookmarksCommand implements BookmarkInterface {

    @Override
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String viewPage = "/WEB-INF/bookmark/getNextBookmarks.jsp";
        ...
        System.out.println("Page: " + pag + " StartIndexNo: " + startIndexNo + " Bookmarks size: " + bookmarks.size());
