...
//			rs = pstmt.executeQuery();
//			if (rs.next()) {
//				user = new UserVO(rs.getInt("userIdx"), rs.getString("id"), rs.getString("password"), rs.getString("nickname"), rs.getString("name"),
//						rs.getString("email"), rs.getString("role"), rs.getString("introduction"), rs.getTimestamp("createdAt"), rs.getTimestamp("updatedAt"),
//						rs.getString("profileImage"), rs.getString("visibility"));
//			}
//		} catch (SQLException e) {
//			e.printStackTrace();
//		} finally {
