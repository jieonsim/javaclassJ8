...
public class AddANewPlaceCommand implements GuestBookInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (createdByStr == null || createdByStr.isEmpty()) {
			...
			request.getRequestDispatcher("/WEB-INF/record/localLog/record-localLog.jsp").forward(request, response);
			return;
		}
		...
		if (placeName == null || placeName.isEmpty() || region1DepthName == null || region1DepthName.isEmpty() || region2DepthName == null
				|| region2DepthName.isEmpty() || categoryIdxStr == null || categoryIdxStr.isEmpty()) {
