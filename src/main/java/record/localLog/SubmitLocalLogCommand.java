...
public class SubmitLocalLogCommand implements GuestBookInterface {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String originalFileNames = multipartRequest.getParameter("originalFileNames");
            ...
            localLogVO.setFileName(originalFileNames);  // Original file names from hidden input
