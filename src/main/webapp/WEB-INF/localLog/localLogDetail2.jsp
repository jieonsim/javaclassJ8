...
#localLogClap {
	...
	font-size: 28px; /* Adjust the size as needed */
	color: black;
	right: 60px; /* Adjust the color as needed */
}
		...
		<div class="row mt-3 pb-5">
			<div class="col-12">
				...
				<div class="d-flex align-items-center mb-3 pt-3">
					...
					<div>
						<div style="font-size: 14px; font-weight: bold;">localLog</div>
						<div class="text-muted" style="font-size: 12px;">2024년 6월 2일 방문</div>
					</div>
				</div>
				<div style="font-size: 14px;">방명록 내용용용용</div>
				<div class="d-flex justify-content-between mt-3">
					<a href="#" data-toggle="modal" data-target="#updateGuestBook" class="text-dark" style="text-decoration: none; font-size: 12px;" data-guestbook-id="${guestBook.guestBookIdx}" data-visibility="${guestBook.visibility}">
